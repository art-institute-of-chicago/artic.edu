...
return [
    ...
    'email_educator_admission_to' => env('EMAIL_EDUCATOR_ADMISSION_TO', 'erc@artic.edu'),
    'email_filming_proposal_to' => env('EMAIL_FILMING_PROPOSAL_TO', 'aic.publicaffairs@artic.edu'),
    'email_ryerson_class_visit_to' => env('EMAIL_RYERSON_CLASS_VISIT_TO', 'libinstruction@artic.edu'),

 ...
 *        @SWG\Property(property="start_date", type="string", description="Start Date"),
 *        @SWG\Property(property="end_date", type="string", description="End Date"),
 ...
 *        @SWG\Property(property="audience", type="string", description="Audience"),
 *     ),
 *
 *     @SWG\Definition(
 *        definition="Article",

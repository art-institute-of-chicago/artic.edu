...
const positionElementToTarget = function(options) {
  ...
  padding.left = (options.padding.left === undefined) ? 0 : padding.left;
  padding.top = (options.padding.top === undefined) ? 0 : padding.top;
  ...
  let left = targetBoundingClientRect.left + padding.left;

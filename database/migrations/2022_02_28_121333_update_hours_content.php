...
class UpdateHoursContent extends Migration
{
    public function up()
    {
        ...
        $hours->monday_public_close = 'PT18H00M';
        ...
        $hours->thursday_public_close = 'PT18H00M';
        ...
        $hours->friday_public_close = 'PT18H00M';
        ...
        $hours->saturday_public_close = 'PT18H00M';
        ...
        $hours->sunday_public_close = 'PT18H00M';

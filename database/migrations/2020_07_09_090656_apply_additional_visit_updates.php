...
class ApplyAdditionalVisitUpdates extends Migration
{
    ...
    public function up()
    {
        ...
        $visitPage->translate('en')->visit_admission_description = '<p>The Art Institute of Chicago provides free access to children under 14, Chicago teens under 18, Link and WIC cardholders, and Illinois educators every day, and to Illinois residents on certain days throughout the year. <a href="/visit/free-admission" target="_blank">Learn more</a><span class="sr-only"> about free access</span>.</p>';

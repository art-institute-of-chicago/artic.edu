...
<head>
  ...
  <link rel="apple-touch-icon" href="/public/dist/images/favicon-152.png"> <!-- General use iOS/Android icon, auto-downscaled by devices. -->
  <link rel="apple-touch-icon" type="image/png" href="/public/dist/images/favicon-120.png" sizes="120x120"> <!-- iPhone retina touch icon -->
  <link rel="apple-touch-icon" type="image/png" href="/public/dist/images/favicon-76.png" sizes="76x76"> <!-- iPad home screen icons -->
  <!-- Favicon Fallbacks for old browsers that don't read .ico -->
  <link rel="icon" type="image/png" href="/public/dist/images/favicon-32.png" sizes="32x32">
  <link rel="icon" type="image/png" href="/public/dist/images/favicon-16.png" sizes="16x16">

  <!--[if lt IE 9]>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js"></script>
  <![endif]-->
  <!-- insert head.js - ideally minified and inline and not linked like this -->
  <script src="/public/dist/scripts/head.js"></script>
  <link rel="stylesheet" type="text/css" href="https://cloud.typography.com/612324/7579192/css/fonts.css" />
  <link href="/public/dist/styles/app.css" rel="stylesheet" />
</head>
...
<div id="a17">
  ...
  <header class="g-header">
    ...
    <nav class="g-header__nav-primary f-body">
      <ul>
    ...
    <nav class="g-header__nav-secondary f-body">
      <ul>
        <li><a href="#">Shop</a></li>
...
<script src="/public/dist/scripts/app.js"></script>
</body>
</html>

        ...
        if ($this->entity->is_public_domain) {
            $details = array_merge($details, $this->formatDetailBlocks([
                '<span id="h-iiif-manifest">IIIF Manifest</span>&nbsp;'
                    ...
                    . '        The International Image Interoperability Framework (IIIF) is a set of open standards that enables access to digital media from libraries, archives, museums, and other cultural institutions around the world.<br/><br/>'

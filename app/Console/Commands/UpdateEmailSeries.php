...
class UpdateEmailSeries extends Command
{
    ...
    private $emailSeries = [
        ...
        'Registration Open' => [
            ...
            'affiliate_member_copy' => '<p>Be sure to reserve your spot at this %%AffiliateGroup%% event.</p>',
            'member_copy' => '<p>Members, be sure to reserve your spot at this member exclusive.</p>',
            'sustaining_fellow_copy' => '<p>Be sure to reserve your spot at this Sustaining Fellows–exclusive event.</p>',

...
class SearchRepository extends BaseApiRepository
{
    ...
    public function forSearchQuery($string, $perPage = null, $columns = [], $pageName = 'page', $page = null, $options = [])
    {
        ...
        $search = $this->model->search($string)
            ->resources(['artworks', 'exhibitions', 'artists', 'agents', 'events', 'articles', 'digital-catalogs', 'printed-catalogs', 'generic-pages', 'research-guides', 'educator-resources', 'press-releases', 'digital-labels'])
            ->aggregationType();

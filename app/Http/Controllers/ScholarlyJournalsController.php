...
use App\Repositories\ScholarlyJournalRepository;
use App\Models\ScholarlyJournal;

class ScholarlyJournalsController extends FrontController
{

    protected $repository;

    public function __construct(ScholarlyJournalRepository $repository)
    {
    ...
    public function index(Request $request)
    {
        ...
        $view_data = [
            ...
            'wideBody' => true,
            'filters' => $filters,
            'listingCountText' => 'Showing '.$items->total().' scholarly journals',
            'listingItems' => $items,
        ];


        return view('site.scholarlyjournals.index', $view_data);
    }

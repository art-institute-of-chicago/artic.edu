...
@component('twill::partials.form.utils._connected_fields', [
    ...
    <a17-fieldset title="Call to Action (Create Tour)" id="create-call-to-action">
        ...
        @formField('input', [
            'name' => 'tours_create_cta_module_header',
            'label' => 'Header',
        ])

        @formField('wysiwyg', [
            'name' => 'tours_create_cta_module_body',
            'label' => 'Body',
            'toolbarOptions' => [
                'italic'
            ],
        ...
        @formField('input', [
            'name' => 'tours_create_cta_module_button_text',
            'label' => 'Button text',
        ])
        ...
        @formField('input', [
            'name' => 'tours_create_cta_module_action_url',
            'label' => 'Action URL',
            'note' => 'e.g. https://join.artic.edu/secure/holiday-annual-fund',
        ])

        @formField('input', [
            'name' => 'tours_create_cta_module_form_tlc_source',
            'label' => 'Form TLC Source',
            'note' => 'e.g. AIC17137L01',
        ])

        @formField('input', [
            'name' => 'tours_create_cta_module_form_token',
            'label' => 'Form Token',
            'note' => 'e.g. pa5U17siEjW4suerjWEB5LP7sFJYgAwLZYMS6kNTEag',
        ])

        @formField('input', [
            'name' => 'tours_create_cta_module_form_id',
            'label' => 'Form ID',
    ...
    <a17-fieldset title="Call to Action (Buy Tickets)" id="tickets-call-to-action">
        ...
        @formField('input', [
            'name' => 'tours_tickets_cta_module_header',
            'label' => 'Header',
        ])

        @formField('wysiwyg', [
            'name' => 'tours_tickets_cta_module_body',
            'label' => 'Body',
            'toolbarOptions' => [
                'italic'
            ],
        ...
        @formField('input', [
            'name' => 'tours_tickets_cta_module_button_text',
            'label' => 'Button text',
        ])
        ...
        @formField('input', [
            'name' => 'tours_tickets_cta_module_action_url',
            'label' => 'Action URL',
            'note' => 'e.g. https://join.artic.edu/secure/holiday-annual-fund',
        ])

        @formField('input', [
            'name' => 'tours_tickets_cta_module_form_tlc_source',
            'label' => 'Form TLC Source',
            'note' => 'e.g. AIC17137L01',
        ])

        @formField('input', [
            'name' => 'tours_tickets_cta_module_form_token',
            'label' => 'Form Token',
            'note' => 'e.g. pa5U17siEjW4suerjWEB5LP7sFJYgAwLZYMS6kNTEag',
        ])

        @formField('input', [
            'name' => 'tours_tickets_cta_module_form_id',
            'label' => 'Form ID',
            'note' => 'e.g. webform_client_form_5111',
        ])
    </a17-fieldset>

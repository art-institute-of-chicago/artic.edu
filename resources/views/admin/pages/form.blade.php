...
@section('contentFields')
    @formField('radios', [
        'name' => 'type',
        'label' => 'Page type',
        'default' => \App\Models\Page::PAGE_TYPE_HOME,
        'inline' => true,
        'options' => [
            [
                'value' => \App\Models\Page::PAGE_TYPE_HOME,
                'label' => 'Home'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_EXHIBITIONS_AND_EVENTS,
                'label' => 'Exhibitions and Events'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_THE_COLLECTION,
                'label' => 'The Collection'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_VISIT,
                'label' => 'Visit'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_ARTICLES,
                'label' => 'Articles landing'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_EXHIBITION_HISTORY,
                'label' => 'Exhibition History'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_COLLECTION,
                'label' => 'Collection landing'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_RESEARCH_LANDING,
                'label' => 'Research landing'
            ],
            [
                'value' => \App\Models\Page::PAGE_TYPE_WRITINGS_LANDING,
    ...
    @component('twill::partials.form.utils._connected_fields', [
        'fieldName' => 'type',
        'fieldValues' => \App\Models\Page::PAGE_TYPE_HOME,
    ...
    @component('twill::partials.form.utils._connected_fields', [
        'fieldName' => 'type',
        'fieldValues' => \App\Models\Page::PAGE_TYPE_VISIT,
        'renderForBlocks' => false
    ])
        @formField('medias', [
            'name' => 'visit_hero',
    ...
    @component('twill::partials.form.utils._connected_fields', [
        'fieldName' => 'type',
        'fieldValues' => \App\Models\Page::PAGE_TYPE_RESEARCH_LANDING,
        'renderForBlocks' => false
    ])
        @formField('input', [

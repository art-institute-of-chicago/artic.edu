...
@endphp
<{{ $tag ?? 'figure' }} data-type="{{ $type }}"{!! isset($media['cc0']) && $media['cc0'] ? ' data-restricted="true"' : '' !!} class="m-media m-media--{{ $size }}{{ (isset($item['variation'])) ? ' '.$item['variation'] : '' }}{{ (isset($variation)) ? ' '.$variation : '' }}">

<ul class="m-search-actions">
    ...
    <li>
        <a href="{{ $onViewLink }}" data-ajax-scroll-target="collection" class="checkbox f-secondary{{ $onViewActive ? ' s-checked' : '' }}" data-gtm-event="on view" data-gtm-event-category="collection-filter" data-gtm-filter="on-view">
            On view
        </a>
    </li>

<div aria-label="{{ $ariaTitle }}" class="dropdown{{ (isset($variation)) ? ' '.$variation : '' }}" data-behavior={!!isset($behavior) ? '"'. $behavior .'"' : "dropdown"!!} {!! isset($attribute) ? $attribute : '' !!} >

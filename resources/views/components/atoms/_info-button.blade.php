<button class="info-button-trigger" data-behavior="infoButtonTrigger" aria-label="Info" aria-expanded="false" {!! (isset($id)) ? ' aria-labelledby="b-'.$id.' h-'.$id.'" data-tooltip-id="'.$id.'" id="b-'.$id.'"' : '' !!}>

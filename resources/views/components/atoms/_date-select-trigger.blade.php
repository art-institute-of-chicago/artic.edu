<span class="date-select-trigger {{ $font ?? 'f-buttons' }}{{ (isset($variation)) ? ' '.$variation : '' }}" data-behavior="selectDate" data-selectDate-mode="range" data-selectDate-displayFormat="friendlyString">

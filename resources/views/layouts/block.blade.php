...
@endphp
<!DOCTYPE html>
<html dir="ltr" lang="en-US" class="no-js{{ (isset($contrastHeader) and $contrastHeader) ? ' s-contrast-header' : '' }}{{ (isset($filledLogo) and $filledLogo) ? ' s-filled-logo' : '' }}{{ $print ? ' s-sans-serif-loaded s-print' : '' }}  {{ !empty($modal) ? 's-modal-active' : '' }}  {{ $pClass }}">
<head>
  <meta charset="utf-8">

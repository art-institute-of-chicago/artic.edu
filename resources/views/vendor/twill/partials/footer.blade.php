...
<footer class="footer">
    <div class="container">
        <span class="footer__copyright">Version {{ config('aic.version') }}</span>
        <span class="footer__version"><a href="https://twill.io" target="_blank" class="f--light-hover" tabindex="0">Made with Twill</a></span>
    </div>
</footer>

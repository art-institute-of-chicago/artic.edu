...
@if (empty($featuredResults) && empty($artists) && empty($pages) && empty($publications) && empty($artworks) && empty($exhibitions) && empty($events) && empty($articles) && empty($researchAndResources))

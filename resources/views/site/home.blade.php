...
@component('components.molecules._m-intro-block')
    @slot('links', array(
        array('label' => 'Plan your visit', 'href' => $_pages['visit'], 'variation' => 'btn', 'font' => 'f-buttons', 'gtmAttributes' => 'data-gtm-event="Plan your visit" data-gtm-event-action="{{Home}}" data-gtm-event-category="nav-cta-button"'),

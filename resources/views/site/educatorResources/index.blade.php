...
@section('content')
    <section class="o-educator-resources" data-behavior='dynamicFilter' data-filter-persist='true'>
        ...
        <div class="m-links-bar__item m-links-bar__item--primary" data-filter-buttons>
            ...
            <a class="checkbox f-secondary"
               data-behavior="dynamicFilterCheckbox"
               data-filter-behavior="filter"
        ...
        <div class="filter-controls">
            <a class="f-secondary"
                  data-behavior="dynamicFilterClear"
                  data-filter-clear-type="non-persistent"
                  style="display: none;">
                <svg aria-hidden="true" class="icon--close"><use xlink:href="#icon--close--24" /></svg> Clear filters
            </a>
        </div>

        <div class="filter-results">
            <h3 class="f-module-title-2"
                 data-behavior="dynamicFilterCount"
                 data-filter-count-template="{current} results">
                Loading...
            </h3>
        </div>

...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="7" rowspan="3">
                <div class="heading-image-container">
                    <img src="{{ $headerImage['src'] ?? 'https://artic-web.imgix.net/7a9ecbc2-7d8c-41e7-8649-650f1cc5c184/PDFheroimage.png?auto=format%2Ccompress&fit=crop&crop=faces%2Ccenter' }}&w=1000&h=563">
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="logos">
                <img class="i-aic-bloomberg" src="{{FrontendHelpers::revAsset('images/my_museum_tour--aic-bloomberg.png')}}">
            </td>
            <td class="gutter"></td>

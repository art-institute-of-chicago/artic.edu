  ...
  <div class="g-header__inner">
      ...
      <nav class="g-header__nav-primary">
        <ul class="f-main-nav">
          <li class='u-hide@small+'>
            <a href="{{ $_pages['buy'] }}" data-gtm-event="top-nav" data-gtm-event-category="tickets-button">Buy Tickets</a>
          </li>
          <li{!! (isset($primaryNavCurrent) && $primaryNavCurrent == 'visit') ? ' class="s-current"' : '' !!}>
            <a href="{{ $_pages['visit'] }}" data-gtm-event="top-nav" data-gtm-event-category="visit">Visit</a>
          </li>
          <li class="u-show@small+{{ (isset($primaryNavCurrent) && $primaryNavCurrent == 'exhibitions_and_events') ? ' s-current' : '' }}">
            <a href="{{ $_pages['exhibitions'] }}" data-gtm-event="top-nav" data-gtm-event-category="exhibitions-and-events">Exhibitions &amp; Events</a>
          </li>
          <li class="u-show@small+{{ (isset($primaryNavCurrent) && $primaryNavCurrent == 'collection') ? ' s-current' : '' }}">
            <a href="{{ $_pages['collection'] }}" data-gtm-event="top-nav" data-gtm-event-category="collection">The Collection</a>
          </li>
      ...
      <nav class="g-header__nav-secondary">
        <ul class="f-secondary">
          <li><a href="{{ $_pages['buy'] }}" data-gtm-event="top-nav" data-gtm-event-category="tickets-button">Buy Tickets</a></li>
          <li><a href="{{ $_pages['become-a-member'] }}" data-gtm-event="top-nav" data-gtm-event-category="member-button">Become a Member</a></li>
          <li><a href="{{ $_pages['shop'] }}" data-gtm-event="top-nav" data-gtm-event-category="shop-button">Shop</a></li>
        </ul>
      </nav>
